      ...
      <div className="w-full max-w-7xl">
        ...
        <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
          <div className="card-wrapper">
            ...
            <div className="team-card">
              ...
              <div className="card-content">
                ...
                <ul className="social-icons">
                  <li>
                    <a 
                      href="https://www.linkedin.com/in/joshua-famor-069a94254/" 
                      target="_blank" 
                  ...
                  <li>
                    <a 
                      href="https://github.com/Joshieww" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      aria-label="GitHub"
                    >
            ...
            <div className="team-card">
              <div className="img-box">
                <img src={nodadodPic} alt="Alfred Dads Nodado" />
              </div>
              <div className="card-content">
                <div className="content-text">
                  <h3>
            ...
            <div className="team-card">
              <div className="img-box">
                <img src={satoPic} alt="Hanna Keziah Sato" />
              </div>
              <div className="card-content">
                <div className="content-text">
                  <h3>
