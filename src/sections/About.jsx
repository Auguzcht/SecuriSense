      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg h-full flex flex-col">
              ...
              <p className="text-gray-600 text-sm text-justify flex-grow">
                Analyzes text, images, and audio simultaneously to identify phishing and social engineering attempts across different communication channels.
              </p>
            </div>
          </AnimatedContent>
          ...
          <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg h-full flex flex-col">
              <div className="w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                <MemoryIcon className="text-white" fontSize="large" />
              </div>
              <h3 className="text-xl text-left font-semibold mb-2 text-gray-800">
                AI-Powered Natural Language Processing
              </h3>
              <p className="text-gray-600 text-sm text-justify flex-grow">
                Detects manipulative or impersonation-based language using transformer-based natural language models.
              </p>
            </div>
          </AnimatedContent>
          ...
          <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg h-full flex flex-col">
              <div className="w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                <TextSnippetIcon className="text-white" fontSize="large" />
              </div>
              <h3 className="text-xl text-left font-semibold mb-2 text-gray-700">
          ...
          <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg h-full flex flex-col">
              <div className="w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                <RemoveRedEyeIcon className="text-white" fontSize="large" />
              </div>
              <h3 className="text-xl text-left font-semibold mb-2 text-gray-800">
                Visual Content Analysis
              </h3>
              <p className="text-gray-600 text-sm text-justify flex-grow">
                Uses OCR and image recognition to detect phishing attempts hidden in screenshots and website images.
              </p>
            </div>
          </AnimatedContent>
          ...
          <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg h-full flex flex-col">
              <div className="w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                <RecordVoiceOverIcon className="text-white" fontSize="large" />
              </div>
              <h3 className="text-xl text-left font-semibold mb-2 text-gray-800">
                Context-Aware Analysis
              </h3>
              <p className="text-gray-600 text-sm text-justify flex-grow">
                Understands sender-receiver relationships, writing tone, and digital signatures to assess credibility beyond surface-level keywords.
              </p>
            </div>
          </AnimatedContent>
          ...
          <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg h-full flex flex-col">
              <div className="w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                <FilterAltIcon className="text-white" fontSize="large" />
              </div>
              <h3 className="text-xl text-left font-semibold mb-2 text-gray-800">
                Multi-Stage Verification
              </h3>
              <p className="text-gray-600 text-sm text-justify flex-grow">
                Cross-verifies content using multiple independent models to minimize false positives and ensure decision reliability.
              </p>
            </div>
          </AnimatedContent>
        </div>
        ...
        <AnimatedContent direction="horizontal" reverse={true} duration={1.2} ease="power3.out" initialOpacity={0.1} animateOpacity scale={1.1} threshold={0.2} delay={0.10}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            <div className="bg-white rounded-xl p-6 hover:scale-105 transition-transform duration-300 shadow-lg col-span-1 sm:col-span-2 lg:col-span-3 h-full flex flex-col">
              <h2 className="text-4xl font-bold text-left mb-4 text-[#042046]">
                Technical Capability
              </h2>
              <p className="text-gray-700 text-base text-justify leading-relaxed flex-grow">
